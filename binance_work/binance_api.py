...
class Binance():
    ...
    def __init__(self, API_KEY, API_SECRET):
        ...
        self.API_SECRET = bytearray(API_SECRET, encoding='cp1251')
    ...
    def call_api(self, **kwargs):
        ...
        if self.methods[command]['private']:
            ...
            payload_str = urllib.parse.urlencode(payload).encode('cp1251')
            sign = hmac.new(
                key=self.API_SECRET,
                msg=payload_str,
            ...
            payload_str = payload_str.decode("cp1251") + "&signature="+str(sign) 
